...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	function fn_list(){
		document.detailForm.action = "/selectSubjectList?page="+1;
		document.detailForm.submit();
		}
    ...
    <div id="content_pop">
    	...
    	<table width="100%" border="1" cellpadding="0" cellspacing="0" style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
    		...
    		<tr>
    			...
    			<td class="tbtd_content">
    				<select id="useYn" name="useYn" class="use">
    					<option value="Y" <c:if test="${detailBoard.USE_YN =='Y'}"> selected="selected" </c:if>>Yes</option>
    					<option value="N" <c:if test="${detailBoard.USE_YN =='N'}"> selected="selected" </c:if>>No</option>
    				</select>
    			</td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			...
    			<td class="tbtd_content">
                    	<input id="regUser" name="regUser"  type="text" value="${detailBoard.REG_USER}" maxlength="10"/>
        				&nbsp;</td>
    		</tr>
    	</table>
      </div>
