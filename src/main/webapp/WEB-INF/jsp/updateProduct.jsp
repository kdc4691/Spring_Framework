...
<script type="text/javascript">
	function fn_updateProduct() {
		document.updateProduct.action = "/updateProduct.do";
...
<body>
	...
	<div class="container">
		<form name="updateProduct" class="form-horizontal" method="post" enctype="multipart/form-data">
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<input type="submit" class="btn btn-primary" value="업데이트" onclick="javascript:fn_updateProduct()">
				</div>
			</div>
		</form>
	</div>
